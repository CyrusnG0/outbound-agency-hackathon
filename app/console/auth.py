...
PUBLIC_PATHS: frozenset[str] = frozenset({
    ...
    "/test-run/sierra",
    "/test-run/zapier",
    "/test-run/central-health-medical-practice",
    "/test-run/central-minds-psychology-therapy-clinic",
    "/test-run/healing-minds",
    "/test-run/hong-kong-psychological-counselling-center",
    "/test-run/inner-compass-psychotherapy-and-trauma-practice",
    "/test-run/lifespan-counselling",
    "/test-run/lo-chan-marriage-and-family-therapist",
    "/test-run/mindworx-clinic-ot-p-healthcare",
    "/test-run/momentum-counselling",
    "/test-run/oasis-hong-kong-centre-for-counselling-psychotherapy",
    "/test-run/renewed-edge",
    "/test-run/therapy-partners",
    "/test-run/winnie-chiu-family-therapy",
    "/test-run/run",
    "/test-run/run/steps.json",
})
